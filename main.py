   ...
   - استشهد بالمصادر الموثوقة"""
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            yield f"⚠️ خطأ في الاتصال بالخادم: {response.status_code}"
...
<body data-theme="dark">
    ...
    <script>
        ...
        function switchTab(tab, element) {
            ...
            switch(tab) {
                case 'code':
                    input.placeholder = 'اكتب متطلبات البرنامج... سأقدم كود كامل مع شرح تفصيلي';
                    break;
                case 'compare':
...
if __name__ == '__main__':
    ...
    print("="*80)
    print("✅ تم تحديث API بنجاح")
    print("✅ تم إصلاح مشكلة التدفق")
    print("="*80)
